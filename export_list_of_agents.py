...
def reportDetails(r,page,num_users_to_export):
    page += 1
    print("[HTTP " + str(r.status_code) + "] - " + "Working on page number " + str(page) + "/" + str(math.ceil(num_users_to_export/100)), end='')
...
while url:
    ...
    # HTTP 400 Range
        ...
        print("\n>>> HTTP 401 received. Couldn't authenticate you. Please review SUBDOMAIN, USERNAME and TOKEN.")
        break
